...
class GenericPsr7StreamTest extends TestCase
{
    public function testStreamString()
    {
        $stream = new GenericPsr7Stream('Hello');
    ...
    {
        $stream = new GenericPsr7Stream(__FILE__, 'r');
    ...
    {
        $stream = new GenericPsr7Stream(fopen(__FILE__, 'r'));
